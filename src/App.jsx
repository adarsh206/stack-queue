      ...
      <div className='wrapper-container'>
        <div className="left-container">
          ...
          <div className="mode-container">
            <div className="mode" style={{backgroundColor: selected === "stack" && "orange", color: selected === "stack" && "black"}} onClick={() => setSelected("stack")}>STACK</div>
            <div className="or">OR</div>
            <div className="mode" style={{backgroundColor: selected === "queue" && "orange", color: selected === "queue" && "black"}} onClick={() => setSelected("queue")}>QUEUE</div>
          </div>
